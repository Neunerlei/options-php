...
class Options {
	 ...
	 *                       from the result.
	 *                       - allowBooleanFlags (bool) TRUE: If set to FALSE it is not allowed to use boolean flags in
	 *                       your input array. Useful when validating API inputs
	 *
	 * @return array
	...
	protected static function getApplier(): OptionApplier {
		if (!empty(static::$applier) && static::$applier instanceof static::$applierClass) return static::$applier;
